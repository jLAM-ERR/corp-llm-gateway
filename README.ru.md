...
Upstream-провайдеры, к которым идёт обращение с BYOK-ключом разработчика: [Anthropic](https://www.anthropic.com) / [OpenAI](https://openai.com). Клиент на ноутбуке: [Claude Code](https://github.com/anthropics/claude-code).
